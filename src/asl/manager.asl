...
+!folyosofelmosas(T) : uresfolyoso | T==7.75 <- !kivalaszt(E); .send(E,achieve,mossfel("folyoso")).	// TODO sorsolhatunk ide több embert, ha akarunk
+!folyosofelmosas(T) : not uresfolyoso .//<- .print("A folyosó most tele van").
...
+!termekkoszosodasa(N,T) : true <- A="IB28"; !koszosodik(N,A,T);
